...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="SEEC-PA | <?php echo $titulo ?>" />

	<!-- OG -->
	<meta property="og:title" content="SEEC-PA | <?php echo $titulo ?>" />
	<meta property="og:description" content="SEEC-PA | <?php echo $titulo ?>" />
	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					<li>
						<a href="/cursos/painel" class="ttr-material-button">
					...
					<li>
						<a href="" class="ttr-material-button">
		                	...
		                	<span class="ttr-label">Curso</span>
                            <span class="ttr-arrow-icon"><i class="fa fa-angle-down"></i></span>
		                </a>
                        <ul>
		                	<li>
		                		<a href="/cursos/aula" class="ttr-material-button">
                                    <span class="ttr-label">
                                       <i class="fa fa-book"></i> Aula
                                    </span></a>
		                	</li>
		                </ul>
		            </li>
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title"><?php echo $titulo ?></h4>
